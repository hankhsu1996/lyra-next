# LRM Signoff Progress

Chapter status for IEEE 1800-2023. See `docs/lrm-signoff.md` for definitions.

| Ch  | Title                                   | Status      | Test path    | Notes           |
| --- | --------------------------------------- | ----------- | ------------ | --------------- |
| 1   | Overview                                | N/A         |              | Informational   |
| 2   | Normative references                    | N/A         |              | Informational   |
| 3   | Design and verification building blocks | In progress | lrm/ch03/\*  |                 |
...
| 30  | Specify blocks                          | Not started |              |                 |
| 31  | Timing checks                           | Not started |              |                 |
| 32  | SDF annotator                           | N/A         |              | Runtime/tool    |
| 33  | Configuring the contents of a design    | Not started |              |                 |
| 34  | Protected envelopes                     | Not started |              |                 |
| 35  | Direct programming interface (DPI)      | N/A         |              | API             |
| 36  | PLI/VPI overview                        | N/A         |              | API             |
| 37  | VPI object model diagrams               | N/A         |              | API             |
| 38  | VPI routine definitions                 | N/A         |              | API             |

Known gaps are tracked in `docs/lrm/gaps.md`.
